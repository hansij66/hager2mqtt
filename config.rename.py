...
# maximum feasible read rate depends on baud rate and number of devices connected
...
# Assumption is that there is only one RS485 bus
...
# Reading burst for the 2 power meters used in this example takes about 0.5 seconds @ 19200
